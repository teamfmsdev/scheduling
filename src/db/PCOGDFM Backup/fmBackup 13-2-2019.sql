...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 13, 2019 at 03:50 AM
...
(151, 'Clogged', 'P2', 'RM', 'UC', 'sink/floor trap clogged at pantry erb building.', 'Erb Building', 'In Progress', 'Nekad (b&i team)', '-', 'Kamarulzaman', '2019-02-10', '', ''),
(152, 'Drawer', 'P3', 'RM', 'HK', 'remove drawer from Vcn warehouse to modular tent.(40 unit)', 'Ccb', 'New', 'Nekad(b&i team)', '-', 'Kamarulzaman', '2019-02-10', '', ''),
(153, 'Clogged', 'P1', 'RM', 'UC', 'floor trap clogged at toilet mntce ground building.', 'Nekad(b&i team)', 'In Progress', 'Nekad (b&i team)', '-', 'Kamarulzaman', '2019-02-10', '', ''),
...
(156, 'TABLES + CHAIRS MINI HALL 1& 2 ON 13 FEBRUARY 2019', 'P1', 'SM', 'HK', 'request set up for Mini Hall 1 & 2 for our KPI Cascading Workshop on Wednesday, 13th February 2019.  Program will start at 9 am until 5 pm.\n\nWe need 6 round tables and 10 chairs for each table. We also need 4 set of flipped chart stand and paper, and also 2 portable screen.(Khalidah Najihah)', 'Mini Hall', 'New', 'Nekad (b&i team)', '-', 'Kamarulzaman', '2019-02-11', '', ''),
...
(158, 'Lean Six Sigma Engagement 12/2/19', 'P1', 'SM', 'HK', 'for Lean Six Sigma Engagement with PETRONAS Management Office and OPU East Coast Six Sigma Focal ..Set-Up U Shape Meeting for 40 pax (Firdaus abe)', 'Salahuddin Al-Ayyubi', 'New', 'Nekad (b&i team)', '-', 'Kamarulzaman', '2019-02-11', '', ''),
(159, 'Arrangement Mini hall 2', 'P1', 'SM', 'HK', 'arrangement at mnihall 2,12/2/2019 classroom style.(ruhani mntce)', 'Amru Bin Asr', 'New', 'Nekad (b&i team)', '-', 'Kamarulzaman', '2019-02-11', '', ''),
...
--
ALTER TABLE `main`
  MODIFY `row` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=161;
COMMIT;
