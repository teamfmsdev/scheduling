...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 03, 2019 at 10:21 AM
...
(22, 'Replace bunting', '', 'PM', 'RP', 'Replace 4 pcs bunting at gate 1\n\n***Job scheduled on 01-01-2019', 'Gate 1', 'Closed', 'Nekad (b&i team)', '-', 'Kamarulzaman', '2018-12-31', 'Kamarulzaman', '2018-12-31'),
(23, 'Tiang terbalik', 'P3', 'PM', 'RS', 'baiki tiang rantai terbalik di parking admin (2 batang)\n\n***Job removed from schedule on 03-03-2019', 'Parking Admin', 'New', 'Nekad (b&i team)', '-', 'Kamarulzaman', '2019-01-02', '', ''),
...
(146, 'Door knob', 'P3', 'PM', 'RP', 'Baiki @pun tukar tombol pintu guard house 3.', 'Guard House 3', 'Closed', 'Nekad (b&i team)', '-', 'Kamarulzaman', '2019-02-03', 'Kamarulzaman', '2019-02-04'),
...
(164, 'Polycabornate wall', 'P3', 'PM', 'HK', 'install new polycarbonate wall at smoking shield ccb 1st floor.', 'Ccb', 'Reviewed', 'Nekad (b&i team)', '-', 'Kamarulzaman', '2019-02-13', '', ''),
...
(186, 'Pintu rosak', 'P2', 'PM', 'RS', 'repair pintu lab(pintu tengah nak masuk ke process area)', 'Lab', 'Closed', 'Nekad (b&i team)', '-', 'Kamarulzaman', '2019-02-19', 'Kamarulzaman', '2019-02-21'),
(187, 'Door knob', 'P3', 'PM', 'RP', 'repair/replace door knob at emergency exit tsd wing a', 'Tsd Wing A', 'Closed', 'Nekad (b&i team)', '-', 'Kamarulzaman', '2019-02-20', 'Kamarulzaman', '2019-03-20'),
(188, 'TO CUT THE TREE', 'P2', 'RM', 'HK', 'TO CUT THE TREE BRANCHES THAT COVER THE VISIBILITY OF FIR HYDRANT (H2203) En Azmi eou', 'Admin', 'Closed', 'Rntsb', '-', 'Kamarulzaman', '2019-02-20', 'Kamarulzaman', '2019-02-23'),
(189, 'Arrangement Mini Hall', 'P3', 'SM', 'HK', 'Kindly need ur team assist for Mini Hall setup and arrangement for EES Maintenance Q4 2018 by 27 Feb 2019(M Halmie mntce)', 'Mini Hall 1&2', 'Closed', 'Nekad (b&i team)', '-', 'Kamarulzaman', '2019-02-20', 'Kamarulzaman', '2019-02-26'),
(190, 'Arrangement Training Room', 'P3', 'SM', 'HK', 'for TSD monthly communication session 27/2/2016(Nur Hafizah Bt M Pisol TSD )', 'Training Room 1&2', 'Closed', 'Nekad (b&i team)', '-', 'Kamarulzaman', '2019-02-20', 'Kamarulzaman', '2019-03-26'),
(191, 'Quality Policy', 'P3', 'PM', 'RP', 'replace quality policy at pcogd', 'Pcogd', 'Closed', 'Nekad (b&i team)', '-', 'Kamarulzaman', '2019-02-20', 'Kamarulzaman', '2019-02-28'),
...
(193, 'LCD Projector', 'P2', 'PM', 'RP', 'HSE need to request the 3 Pak Ciks to install the LCD Projector at HSE ERB Meeting Room.(Norhazita Ngah)', 'Erb Building', 'Closed', 'Nekad (b&i team)', '-', 'Kamarulzaman', '2019-02-24', 'Kamarulzaman', '2019-02-24'),
(194, 'Relocate Cubicle', 'P2', 'PM', 'HK', 'request pakcik 3 to relocate cubicle partition at EOG Office. \n(Norazreen Bt Zahari)\n\n***Job reopened on 03-03-2019\n\n***Job completed on 03-03-2019', 'Eou Office', 'Closed', 'Nekad (b&i team)', '-', 'Kamarulzaman', '2019-02-24', 'Support Team', '2019-03-03'),
(195, 'Sink issue in Warehouse toilet', 'P1', 'PM', 'RS', 'the piping under the sink  in the warehouse toilet ( beside receiving office ) is still leaking and caused water dripping to floor .\n(Wan Khairul Annam Wan Ali)', 'Warehouse', 'Closed', 'Nekad (b&i team)', '-', 'Kamarulzaman', '2019-02-24', 'Kamarulzaman', '2019-02-25'),
...
(198, 'Install Signage', 'P2', 'PM', 'PR', 'request pokcik to install signage at Olefin plant on Thursday morning.\n(Shamsury B Omar ole)', 'Olefin Plant', 'Closed', 'Nekad (b&i team)', '-', 'Kamarulzaman', '2019-02-27', 'Kamarulzaman', '2019-03-28'),
(199, 'Walkway', 'P3', 'PM', 'HK', 'remove temporary walkway at ccb.', 'Ccb', 'Closed', 'Nekad (b&i team)', '-', 'Kamarulzaman', '2019-02-27', 'Kamarulzaman', '2019-03-28'),
(200, 'Clogged', 'P1', 'PM', 'UC', 'check n rectify floor trap at erb building,need to open manhole', 'Erb', 'New', 'Nekad (b&i team)', '-', 'Kamarulzaman', '2019-03-01', '', ''),
(201, 'clogged', 'P1', 'PM', 'UC', 'drainage clogged at cafeteria.', 'Cafeteria', 'New', 'Nekad (b&i team)', '-', 'Kamarulzaman', '2019-03-01', '', ''),
(202, 'Install Soft Board at Derivatives shelter', 'P3', 'SM', 'RS', 'Install Soft Board at Derivatives shelter\n(Jumaida)\n\n***Job scheduled on 03-03-2019\n\n***Job completed on 03-03-2019', 'Derivatives Shelter', 'Closed', 'Nekad', '-', 'Aqil', '2019-03-03', 'Support Team', '2019-03-03'),
(203, 'Kebocoran atas ceiling di Chemicals Dept', 'P2', 'RM', 'RS', 'Kebocoran atas ceiling di Chemicals Dept, meyebabkan air titik\n\n***Job scheduled on 03-03-2019\n\n***Job completed on 03-03-2019', 'Chemicals Dept', 'Closed', 'PCOGD', '-', 'Zamri', '2019-03-03', 'Support Team', '2019-03-03');
...
--
ALTER TABLE `main`
  MODIFY `row` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=204;
COMMIT;
