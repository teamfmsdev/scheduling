...
('2019-02-01', 59, '', '', 0),
('2019-02-09', 60, '', '', 0),
('2019-01-02', 61, '17', 'Replace bunting', 0),
('2019-02-21', 66, '25', 'Repair door', 0);
...
--
ALTER TABLE `bia`
  MODIFY `row` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
...
--
ALTER TABLE `ptw`
  MODIFY `row` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=318;
