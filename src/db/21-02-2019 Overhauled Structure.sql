...
CREATE TABLE `bia` (
  `date` date NOT NULL,
  `fmNo` int(32) NOT NULL,
  KEY `date` (`date`),
  KEY `fmNo` (`fmNo`),
  CONSTRAINT `bia_ibfk_1` FOREIGN KEY (`date`) REFERENCES `parentrow` (`date`),
  CONSTRAINT `bia_ibfk_2` FOREIGN KEY (`fmNo`) REFERENCES `biaentry` (`fmNo`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `bia` (`date`, `fmNo`) VALUES
('2019-01-01',	333),
('2019-01-01',	434),
('2019-01-01',	467),
('2019-01-04',	333);
...
CREATE TABLE `biaentry` (
  `fmNo` int(32) NOT NULL,
  `activities` text NOT NULL,
  PRIMARY KEY (`fmNo`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `biaentry` (`fmNo`, `activities`) VALUES
(333,	'C'),
(434,	'A'),
(467,	'B');
...
CREATE TABLE `cm` (
  `date` date NOT NULL,
  `cmItem` int(32) NOT NULL,
  KEY `date` (`date`),
  KEY `cmItem` (`cmItem`),
  CONSTRAINT `cm_ibfk_1` FOREIGN KEY (`date`) REFERENCES `parentrow` (`date`),
  CONSTRAINT `cm_ibfk_2` FOREIGN KEY (`cmItem`) REFERENCES `cmentry` (`cmItem`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `cm` (`date`, `cmItem`) VALUES
('2019-01-01',	1),
('2019-01-01',	2),
('2019-01-01',	3);

DROP TABLE IF EXISTS `cmentry`;
CREATE TABLE `cmentry` (
  `cmItem` int(32) NOT NULL AUTO_INCREMENT,
  `activities` text NOT NULL,
  PRIMARY KEY (`cmItem`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `cmentry` (`cmItem`, `activities`) VALUES
(1,	'A'),
(2,	'B'),
(3,	'C');
...
CREATE TABLE `pa` (
  `date` date NOT NULL,
  `paItem` int(11) NOT NULL,
  KEY `date` (`date`),
  KEY `paItem` (`paItem`),
  CONSTRAINT `pa_ibfk_1` FOREIGN KEY (`date`) REFERENCES `parentrow` (`date`),
  CONSTRAINT `pa_ibfk_2` FOREIGN KEY (`paItem`) REFERENCES `paentry` (`paItem`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `pa` (`date`, `paItem`) VALUES
('2019-01-01',	1),
('2019-01-01',	2),
('2019-01-01',	3);

DROP TABLE IF EXISTS `paentry`;
CREATE TABLE `paentry` (
  `paItem` int(11) NOT NULL AUTO_INCREMENT,
  `activities` text NOT NULL,
  PRIMARY KEY (`paItem`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `paentry` (`paItem`, `activities`) VALUES
(1,	'A'),
(2,	'B'),
(3,	'C');
...
('2019-01-01',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-02',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-03',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-04',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-05',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-06',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-07',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-08',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-09',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-10',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-11',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-12',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-13',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-14',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-15',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-16',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-17',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-18',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-19',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-20',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-21',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-22',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-23',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-24',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-25',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-26',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-27',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-28',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-29',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-30',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
('2019-01-31',	'p2',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0',	'p0'),
...
CREATE TABLE `ptw` (
  `date` date NOT NULL,
  `ptwNo` int(32) NOT NULL,
  KEY `date` (`date`),
  KEY `ptwNo` (`ptwNo`),
  CONSTRAINT `ptw_ibfk_3` FOREIGN KEY (`ptwNo`) REFERENCES `ptwentry` (`ptwNo`),
  CONSTRAINT `ptw_ibfk_4` FOREIGN KEY (`date`) REFERENCES `parentrow` (`date`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `ptw` (`date`, `ptwNo`) VALUES
('2019-01-01',	1),
('2019-01-01',	2),
('2019-01-01',	3);

DROP TABLE IF EXISTS `ptwentry`;
CREATE TABLE `ptwentry` (
  `ptwNo` int(32) NOT NULL,
  `activities` text NOT NULL,
  PRIMARY KEY (`ptwNo`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `ptwentry` (`ptwNo`, `activities`) VALUES
(1,	'A'),
(2,	'B'),
(3,	'C');
